...
| ---------------------------------------------- | ----------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| RLS is only a `children` CRUD tracer           | multi-resource transactions need a broader role design      | dedicated runtime role, ADR-0016 NO-GO gate, ownership tests, staged follow-up        |
