...
| LP-P2-02 | 紙片と card の境界をさらに詰める   | まだ一部が整ったカード UI に見える                                  | 対応済み。ISSUE-101 で LP 専用 paper surface / paper slip / paper link primitive を追加し、shadow、radius、hairline を紙片寄りに調整 |
