...
| `review`      | 2     | LP prototype / BottomNav icons |
| `done`        | 75    | archive を参照                 |
| `blocked`     | 2     | 人間判断待ち                   |
...
| 4     | `ISSUE-079` | `#177` | BottomNav と action icon の quiet alignment   | review                      |
...
| `ISSUE-079` | BottomNav と action icon の quiet alignment       | icon language 適用・専門レビュー済み |
...
- lp-app design parity completed: `ISSUE-076`, `ISSUE-077`, `ISSUE-078`
