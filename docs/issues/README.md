...
| `review`      | 1     | `ISSUE-043` の PR review 待ち            |
| `done`        | 43    | archive を参照                           |
| `blocked`     | 3     | 認証済み実データ QA とデザイン後続 Issue |
...
| `ISSUE-044` | `ISSUE-043` でデザイン組織・専門家ペルソナ・レビュー運用を先に定義する                                  |
| `ISSUE-045` | `ISSUE-043` と `ISSUE-044` を完了し、評価体制と Rubric を確定する                                       |
...
| ----------- | ---------------------------------------------------- |
| `ISSUE-043` | デザイン組織・レビュー運用・サブエージェント体制のPR |
