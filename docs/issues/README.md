...
| `review`      | 13    | foundation 5件 + automation setup 3件 + security/privacy + release readiness + route-map check + loading/prefetch + TanStack Query |
| `done`        | 22    | archive を参照                                                                                                                     |
...
| 2    | `ISSUE-022` | P2       | S    | ai / perf     | 実装着手は可能。AI / image privacy gate は PR review 前に必ず確認         | `pnpm pr:gate`, AI privacy check |
