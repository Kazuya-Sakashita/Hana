...
| `review`      | 2     | LP prototype / Record alignment |
| `done`        | 74    | archive を参照                  |
| `blocked`     | 2     | 人間判断待ち                    |
...
| 3     | `ISSUE-078` | `#175` | Record 30秒 one-decision flow alignment       | review                      |
...
| `ISSUE-078` | Record 30秒 one-decision flow alignment           | primitive 適用・専門レビュー済み |
...
- lp-app design parity completed: `ISSUE-076`, `ISSUE-077`
