...
| 7     | `ISSUE-101` | `#226` | LP の紙片と card 境界を Quiet Heirloom に寄せる   | review |
...
- `ISSUE-101` / `#226`: PR 作成 / review / merge 待ち。merge 後に done archive へ同期する。
...
- maintenance completed: `ISSUE-039`, `ISSUE-042`, `ISSUE-052`, `ISSUE-065`, `ISSUE-088`, `ISSUE-090`, `ISSUE-092`, `ISSUE-094`, `ISSUE-096`, `ISSUE-098`, `ISSUE-100`
