...
PR #386も固定SHAのRound 3でterminal HOLDになったため、このIssueでは追加修正・Round 4・mergeを行わない。未完了の署名境界はISSUE-192へ移管する。
...
- GitHub PR #386（Round 3 terminal HOLD、未マージ）
- ISSUE-192 / GitHub Issue #387
- ISSUE-173
