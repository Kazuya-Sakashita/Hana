...
export function assertSyntheticE2eEnvironment(environment: { [key: string]: string | undefined }): {
  databaseUrl: string
  directUrl: string
} {
  if (environment.HANA_SYNTHETIC_E2E !== '1') throw new Error('synthetic_e2e_opt_in_required')
  ...
  if (databaseUrl.toString() !== directUrl.toString()) throw new Error('database_urls_must_match')
